<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroEmpresa.aspx.cs" Inherits="CadastroEmpresa.CadastroEmpresa" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <table style="margin:auto;">
                <tr><td colspan="3" style="text-align:center;" ><h3>CADASTRAR EMPRESA</h3></td></tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" style="width:150px;">
                        <asp:TextBox ID="txtFaturamento" runat="server" Width="300px" />
                    </td>
                </tr>
                <tr>
                    <td style="width:150px; text-align:center;">
